...
public class DDADAO {
    ...
    public int getBalance(int accountno) {
        if (useRealDB == true) {
            ...
            return (int) Integer.parseInt(fakeDBACCOUNTS.get(accountno-1)[3]);
        }
    }
    ...
    public ArrayList<String> getTransactionsStatement(int accountNo,  String start, String end) {
        ...
        if (useRealDB == true) {
            ...
            for (int i = 0; i < fakeDBTRANSACTIONS.size(); i++) {
                if (fakeDBTRANSACTIONS.get(i)[1].equals(Integer.toString(accountNo)) && fakeDBTRANSACTIONS.get(i)[4].compareTo(start) >= 0 && fakeDBTRANSACTIONS.get(i)[4].compareTo(end) <= 0){
